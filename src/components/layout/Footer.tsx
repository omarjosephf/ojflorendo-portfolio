      ...
      <Container>
        ...
        <div className="flex flex-col items-start justify-between gap-8 sm:flex-row sm:items-center">
          <Link href="/#top" className="flex items-center gap-3" aria-label="Back to top">
            <Monogram />
            <div><p className="text-sm font-semibold">{site.name}</p><p className="mt-1 text-xs text-muted">{site.location}</p></div>
          </Link>
        ...
        <div className="mt-8 flex flex-col gap-3 border-t border-line pt-6 text-xs text-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="sm:text-right"><p>Designed and built by OJ Florendo Rayatchi.</p><p className="mt-1">Next.js · TypeScript · AI-assisted engineering</p></div>
        </div>
      </Container>
    </footer>
  );
